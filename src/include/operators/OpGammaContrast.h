 ...
 */
NVCV_OP_PUBLIC NVCVStatus nvcvopGammaContrastCreate(NVCVOperatorHandle *handle, const int32_t maxVarShapeBatchSize,
 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
NVCV_OP_PUBLIC NVCVStatus nvcvopGammaContrastVarShapeSubmit(NVCVOperatorHandle handle, cudaStream_t stream,
