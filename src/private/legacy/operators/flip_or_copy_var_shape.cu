...
template<typename T>
void flip(const IImageBatchVarShapeDataStridedDevice &input, const IImageBatchVarShapeDataStridedDevice &output,
          const ITensorDataStridedDevice &flipCode, cudaStream_t stream)
{
...
ErrorCode FlipOrCopyVarShape::infer(const IImageBatchVarShapeDataStridedDevice &input,
                                    const IImageBatchVarShapeDataStridedDevice &output,
                                    const ITensorDataStridedDevice &flipCode, cudaStream_t stream)
{
    ...
    // using flip_t = void(const IImageBatchVarShapeDataStridedDevice & input,
    //                     const IImageBatchVarShapeDataStridedDevice & output,
    //                     const ITensorDataStridedDevice & flipCode,
    //                     cudaStream_t stream);
    typedef void (*flip_t)(const IImageBatchVarShapeDataStridedDevice &input,
