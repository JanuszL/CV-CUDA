...
template<typename T>
void resize(const IImageBatchVarShapeDataPitchDevice &in, const IImageBatchVarShapeDataPitchDevice &out,
...
ErrorCode ResizeVarShape::infer(const IImageBatchVarShapeDataPitchDevice &inData,
